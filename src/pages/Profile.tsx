...
import { User as UserIcon, Shield, LogOut, Calendar } from 'lucide-react';
    ...
    if (location.pathname === '/profile/preferences') {
        ...
        content = (
            <div className="max-w-4xl mx-auto px-6 py-12">
                ...
                <div className="bg-gray-900/50 border border-white/5 rounded-3xl p-8 backdrop-blur-sm">
                    <p className="text-gray-400">Password management and security settings will appear here.</p>
                </div>
            </div>
        );
    } else {
