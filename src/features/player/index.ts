// features/player — public API. Import from '@/features/player'. See ARCHITECTURE.md.
// Route screens:
export { Player } from './components/Player';
export { MpvOverlay } from './components/MpvOverlay';
// Player toolkit (used by the screens and reusable elsewhere):
